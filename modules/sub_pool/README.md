...
| [aws_vpc_ipam_preview_next_cidr.sub](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/vpc_ipam_preview_next_cidr) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_cidr"></a> [cidr](#output\_cidr) | IPAM sub pool provisioned CIDR info. |
| <a name="output_pool"></a> [pool](#output\_pool) | IPAM sub pool info. |
<!-- END_TF_DOCS -->